...
type IProxy interface {
	...
	ContentManagementListProjectSources(auth AuthParams, project string) ([]sumamodels.ContentManagementSource, error)
	...
	SystemListInActiveSystems(auth AuthParams) ([]sumamodels.ActiveSystem, error)
